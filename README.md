...
Click *Select*, which opens a window similar to the previous step that asks for a .tocl file. Then, open the file containing the property that will be analyzed.
...
To use a previously created configuration, click on the *Configuration method* dropdown and select *Upload .properties file*.
